...
def takeOrder():
    while True:
        ...
        if(found_item=="none"):
            ...
            orders.append({"title":user_input,"quantity":quantity,"rate":rate})
...
def show_bill():
    ...
    for order in orders:
        ...
        print(order['title'].capitalize(),"*",order['quantity'],"=",order['quantity']*order['rate'])
        total_cost+=cost
    print("================================================")
    print("")
